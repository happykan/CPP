...
int main()
{
    //Planet solarSystem[2] = {1,2};
    Planet solarsystem[8] = {
        Planet("Mercury", 69.592, 0.33, 4879.4, 0, Moon("No Moon", 0, 0, 0), Moon("No Moon", 0, 0, 0), Moon("No Moon", 0, 0 ,0)),
    ...
    cout<<"Find the planet Moon Europa is "<<findMoon(Moon("Europa", 670900, 3126, 480), solarsystem)<<endl;
